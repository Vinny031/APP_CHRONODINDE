...
export const JAUGES_CONFIGS: Record<JaugeId, JConfig> = {
  ...
  caresseur:  { iconClass: 'fa-solid fa-plus',     iconBg: 'bg-pink-500/20',   textClass: 'text-pink-400',   borderClass: 'border-pink-400/60',   dotClass: 'bg-pink-400',   fillClass: 'bg-pink-400',   glowClass: 'glow-pink',   accentColor: '#f472b6', fillColor: '#c084fc', glowShadow: '0 0 10px rgba(192,132,252,0.6)', bg: 'rgba(192,132,252,0.18)', border: 'rgba(192,132,252,0.75)', text: '#c084fc', glow: '0 0 12px rgba(192,132,252,0.8)' },
...
export const PALETTES: PaletteConsommation[] = [
  { seuilMin: 90001, seuilMax: 100000, delta: 40 },
  { seuilMin: 70001, seuilMax: 90000,  delta: 30 },
  { seuilMin: 40001, seuilMax: 70000,  delta: 20 },
  { seuilMin: 0,     seuilMax: 40000,  delta: 10 },
]
